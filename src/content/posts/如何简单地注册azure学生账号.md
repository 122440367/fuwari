...
众所周知，微软作为一大企业巨头，经常给用户发福利。如果你是学生，往往能享受到更好的福利，比如github学生包，等等。但是由于使用（薅羊毛）的人过多，后果也很明显——对于中国用户来说，申请azure学生版变得更加困难。本文旨在介绍如何简单地注册azure

## 心路历程（失败原因）

首先，我们需要有一个学生邮箱

打开浏览器，输入 https://azure.microsoft.com/zh-cn/free/students 进入azure的注册界面。点击 “免费开始使用“ 的绿色按钮，这里会要求你登录微软账号。我直接登录了我的微软账号。

登录完成后，按照真实情况填写好个人信息。

点击验证学术地位，然后微软就会往你的学校电子邮箱里发送一封邮件，按照提示操作。

进入到后续页面中，填写地址信息（PS:如果提示地址未能验证，可以使用翻译软件翻译成英文再提交）
...
这种情况有解决方法，你可以通过Microsoft service Hub寻求azure客服帮助，补充提交一些资料，但截至撰稿时仍未解决问题



## 真正的解决方法

众所周知，github 是微软的，那么我们可以通过 github 学生认证的方式跳过azure繁复的认证操作

我们需要提前获得github的学生认证，推荐使用”笔记本“方法注册，作者使用此方法成功，具体可上网自行查找

取得学生认证后，打开 https://education.github.com/pack ，登录一下，点击左上角的三个横杠，
